<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductSellList.aspx.cs" Inherits="chengxusheji.Admin.ProductSellList" %>
...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">商品出售管理 》》商品出售列表</div>
     <div class="Body_Search">
        商品名称&nbsp;&nbsp;<asp:TextBox ID="productName" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        商品分类&nbsp;&nbsp;<asp:DropDownList ID="productClassObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
        新旧程度&nbsp;&nbsp;<asp:DropDownList ID="xjcdObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpProductSell" runat="server" onitemcommand="RpProductSell_ItemCommand">
        <HeaderTemplate>
        ...
        <ItemTemplate>
            <tr>
                <td align="center"><input type="checkbox" value='<%#Eval("sellId") %>' name="CheckMes" id="DelChecked"/></td>
                <td align="center"><%#Eval("sellId")%> </td>
                ...
                <td align="center"><%#Eval("sellPrice")%> </td>
                ...
                <td align="center"><a href="ProductSellEdit.aspx?sellId=<%#Eval("sellId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("sellId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
