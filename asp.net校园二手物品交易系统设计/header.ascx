...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">校园二手网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>ProductOrder/frontlist.aspx">商品订单</a></li>
                <li><a href="<%=basePath %>Xjcd/frontlist.aspx">新旧程度</a></li>
                -->
                <li><a href="<%=basePath %>ProductClass/frontlist.aspx">商品分类</a></li>
                <li><a href="<%=basePath %>ProductSeek/frontlist.aspx">商品求购</a></li>
                <li><a href="<%=basePath %>ProductSell/frontlist.aspx">商品出售</a></li> 
                
                <li><a href="<%=basePath %>Leaveword/frontlist.aspx">网站留言</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel"> 
                        ...
                        <li><a href="<%=basePath %>ProductSeek/frontUserAdd.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布商品求购</a></li>
                        <li><a href="<%=basePath %>ProductSeek/userFrontlist.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的求购</a></li>
                        <li><a href="<%=basePath %>ProductOrder/frontUserList.aspx"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的订单信息</a></li>
                        <li><a href="<%=basePath %>ProductSell/frontUserAdd.aspx"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;发布出售商品</a></li>
                        <li><a href="<%=basePath %>ProductSell/userFrontlist.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我发布的出售</a></li>
                        <li><a href="<%=basePath %>UserInfo/frontSelfModify.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;修改个人信息</a></li>
